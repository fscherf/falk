...
def test_post_multipart_requests(args, page, start_falk_app):
    """
    This test tests file uploads using `/request-handling/multipart-forms-2`
    in the test app.
    """
    ...
    with tempfile.TemporaryDirectory() as root:
        ...
        # go to form
        url = base_url + "/request-handling/multipart-forms-2"

        page.goto(url)
        page.wait_for_selector("h2:text('Multipart Forms 2')")
